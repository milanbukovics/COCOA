...
#| label: fig-bf-14
#| echo: false
#| fig-cap: "Return Ratio for $g_{m2}$ with the output port open"
#| width: 10%
...
with sd.Drawing() as d:
    ...
    elm.Line().at(L3.end).right().dot().label('$v_{out}$',loc='rgt').length(3).label(r'$v_x = -i_t \cdot r_{o2}$',color='blue',loc='top')
