...
statics. For a ground-up treatment from first principles,
...
@fig-2.2(a), where the bulk and source are connected to a reference potential (GND), $V_{GS}$ = 0V and $V_{DS}$ = 0 V. Under this condition, the drain and
...
traveling from the source to the drain is proportional to the lateral electric field in the channel.
...
![Plot of n-channel drain current as a function of $V_{GS}$ 
(transfer characteristic). Parameters: $V_{DS}$ = 5 V, 
$μC_{ox}$ = 50μA/$V^2$,$V_{Tn}$ = 0.5 V, and $W/L$ = 10.](images/png/
figure2.5.png){#fig-2.5 width=100%}


&nbsp;&nbsp;&nbsp;Table 2-1 summarizes the first-order MOSFET I-V 
...
![Load line plot for the CS amplifier in @fig-2.7(a).Parameters: 
$V_{DD}$ = 5 V, $R_D$ = 5 kΩ, and $W/L = 20$.]
(images/png/figure2.8.png){#fig-2.8 width=50%}
