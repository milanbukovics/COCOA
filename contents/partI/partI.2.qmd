...
**[Example 2-3]{#example-2-3}: Output Voltage Calculations for a Common-Source Voltage Amplifier**
...
### The $\lambda$-Model {#the-lambda-model}
...
### Common-Source Voltage Amplifier Analysis Using the $\lambda$-Model {#common-source-voltage-amplifier-analysis-using-the-lambda-model}
...
&nbsp;&nbsp;&nbsp;[Table 2-3](#tbl-lambda-model) summarizes the technology parameters
