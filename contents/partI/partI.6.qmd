...
transresistance of the CG-CD configuration are lower 
than those of the CG-CS configuration 
by $g_{m2} R_{D2}$. The proper topological choice 
...
[Chapters 3](#frequency-response-of-the-common-source-amplifier) and 
...
The OCT result is therefore off by about –26%, which is consistent with 
our  understanding from [Chapter 3](#frequency-response-of-the-common-source-amplifier). 
OCT bandwidth estimates are always conservative and 
tend to be off by 20–30% when there are several 
significant time constants.
...
$$
p_2 = -\frac{1}{R_{D1} \left[ C_{x} + \left(1 - A'_{v20}\right) C_{gs2} \right]}
$${#eq-6.7}
...
### Pole Calculations for the CS-CG Cascade (Cascode Amplifier)$^*$ {#pole-calculations}
