...
# Frequency Response of the Common-Source Voltage Amplifier {#frequency-response-of-the-common-source-amplifier}
...
@fig-3.7, assuming $W$ = $20 μm$, $L$ = $1 μm$,
$C_{ox}$ =  $2.3$ $fF/μm^2$ and $R_s = 50$ $k\Omega$. Express the result in units of Hertz.
...
[Example 3-5](#example-3-5)). Assume $R_{out}$ = $5$ $k\Omega$ and $R_s$ = $50$ $k\Omega$.
...
$10$ $fF$, $C_{db}$ = $11.6$ $fF$,
$R_{out}$ = $5$ $k\Omega$ and $R_s$ = $50$ $k\Omega$ (same as in [Example 3-6](#example-3-6)).
...
first-order,
reducing Rout to approximately $4$ $k\Omega$ (a $20\%$ 
reduction from the original value of $5$ $k\Omega$) should
...
= $5$ $k\Omega$ and $R_s$ = $50$ $k\Omega$ (same as in [Examples 3-7](#example-3-7). Compare 
...
$I_B = 3$ $mA$, $V_B$ = $2.5$ $V$, $C_L$ = $100$ $fF$, $R_D$ = $1$ $k\Omega$ and
$R_s$ = $10$ $k\Omega$ .
...
$R_s = 2R_D$, $R_D$ = $5$ $k\Omega$, $C_L$ = $1$ $pF$.
...
$R_G = 10$ $k\Omega$, $R_S$ = $1$ $k\Omega$, $R_D$ = $5$ $k\Omega$,
 $I_D$ = $500$ $\mu A$,
